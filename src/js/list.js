            ...
            <div class="list">
                ...
                <div class="card-composer hide">
                  <div class="card-composer list-card">
                    <div class="card-composer list-card-details">
                      <textarea class="card-composer-textarea hover" placeholder="Enter a title for this card ..."></textarea>
                    </div>
                  </div>
                  <div class="controls">
                    <div class="controls-section">
                      <input class="new-card-button hover" type="button" value="Add card">
              ...
              <div class="card-composer-container">
                <a class="open-card-composer hover">
                  ...
                  <span class="add-a-card">Add another card</span>
                </a>
              </div>
            </div>
          </div>
